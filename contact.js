function formCheck() {
  ...
  function updateBorderStyle(element, isValid) {
    var borderStyle = isValid ? "5px solid #e6e6e6" : "5px solid #ff4500";
...
if (input3.length > 0) {
  ...
  if (arr.length == 3) {
    ...
    document.getElementById('validation-box').innerHTML = "<p class = 'sub-message'>Form Submitted</p>";
    ...
    document.getElementById('validation-box').innerHTML = "<p class = 'sub-message'>Missing information!</p>";
  }
